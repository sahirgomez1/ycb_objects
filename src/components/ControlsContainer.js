...
import { useCameraStore, useObjectStore, useVideoStore } from "../stores";

const ControlsContainer = () => {
 
  const { camPosition, handleCameraPosition } = useCameraStore();
  ...
  const handleChangeCam = (e) => {
    ...
    handleCameraPosition({ ...camPosition, [name]: parseFloat(value) });
  };
                ...
                <Tab.Pane eventKey="object">
                  <div>
                    ...
                    <InputGroup size="sm" className="mb-3">
                      <label className="h5">
                        X:{" "}
                        {Math.round(objRotation._x * (180 / Math.PI) * 10) / 10}{" "}
                      </label>
                      <input
                        type="range"
                        className="tactile-slider"
                    ...
                    <InputGroup size="sm" className="mb-3">
                      <label className="h5">
                        Y:{" "}
                        {Math.round(objRotation._y * (180 / Math.PI) * 10) / 10}{" "}
                      </label>
                      <input
                        type="range"
                        className="tactile-slider"
                    ...
                    <InputGroup size="sm" className="mb-3">
                      <label className="h5">
                        Z:{" "}
                        {Math.round(objRotation._z * (180 / Math.PI) * 10) / 10}
                      </label>
                      <input
                        type="range"
                        className="tactile-slider"
